-- CreateEnum
CREATE TYPE "FormStatus" AS ENUM ('PENDING', 'SAVED', 'PENDING_HOD', 'REJECTED_HOD', 'CONFIRMED_HOD', 'PENDING_DEAN', 'REJECTED_DEAN', 'APPROVED');

-- CreateEnum
CREATE TYPE "ProjectStatus" AS ENUM ('PENDING', 'SAVED', 'PENDING_HOD', 'CONFIRMED_HOD', 'REJECTED_HOD', 'PENDING_DEAN', 'REJECTED_DEAN', 'APPROVED');
