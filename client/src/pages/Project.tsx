  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-8">
          ...
          <div className="flex justify-between items-start">
            <div>
              ...
              <div className="text-sm text-gray-600 space-y-1.5 flex flex-col sm:flex-row sm:space-y-0 sm:space-x-6">
                ...
                <p><span className="font-semibold text-gray-700">Duration:</span> {project.duration || "N/A"}</p>
      ...
      <div className="mt-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6 min-h-[400px]">
        ...
        {activeTab === 2 && <div className="flex items-center justify-center h-full min-h-[200px] text-gray-400 font-medium">Progress report coming soon</div>}
        {activeTab === 3 && <div className="flex items-center justify-center h-full min-h-[200px] text-gray-400 font-medium">Completion stage coming soon</div>}
      </div>
      </div>
    </div>
  )
