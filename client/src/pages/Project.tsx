        ...
        {tabs.map(tab => (
          ...
          >
            <div className="flex flex-col items-center">
              <span className={`w-8 h-8 flex items-center justify-center text-lg border rounded-full mb-1 ${
                activeTab === tab.id ? "bg-blue-800 text-white" : "bg-gray-100 text-gray-600"
              }`}>
                {tab.id}
              </span>
